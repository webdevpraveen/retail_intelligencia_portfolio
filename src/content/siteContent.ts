...
export const siteContent: SiteContent = {
  ...
  features: [
    ...
    },
    {
      ...
      title: 'Real-Time Visual Processing',
      description: 'Processes incoming frames through the AI and computer-vision pipeline in real time.',
      status: 'prototype',
      statusLabel: 'Prototype capability — to be validated',
      mediaKey: 'demo-realtime',
      features: ['Low latency inference', 'High frame rate processing', 'Optimized edge execution'],
    },
    {
      id: 'detection-visualization',
      title: 'Detection Visualization',
      description: 'Displays bounding boxes, labels, confidence values, and model output on processed frames.',
      status: 'prototype',
      statusLabel: 'Prototype capability — to be validated',
      mediaKey: 'demo-visualization',
      features: ['Clear bounding boxes', 'Confidence score display', 'Real-time telemetry overlay'],
    },
    {
